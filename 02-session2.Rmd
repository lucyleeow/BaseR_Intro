...
Formally, when using a function, always include brackets (`( )`) after the name of the function. Within the brackets is where input (technically 'arguments') to the function goes. 
