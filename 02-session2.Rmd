...
1. Take a look at what the `rnorm()` function outputs in the following code and have a go plugging various inputs to the function. Then try to answer the following questions:
