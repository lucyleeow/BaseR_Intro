...
The data files require for this workshop are available on [Github](https://github.com/lucyleeow/BaseR_Intro/tree/master/data). To download a data file click on the file you wish to downlaod then right click 'Raw' > 'Save Link As...':
